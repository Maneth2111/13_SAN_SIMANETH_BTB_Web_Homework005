...
export default function HomePage() {
  const items = [
    { id: 1, image: bookImg, icon: bookIcon, category: "Book" },
    { id: 2, image: cartoonImg, icon: cartoonIcon, category: "Cartoon" },
  ];
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-around">
        {items.map((item) => (
          <div key={item.id} className="rounded-lg shadow-md relative group">
